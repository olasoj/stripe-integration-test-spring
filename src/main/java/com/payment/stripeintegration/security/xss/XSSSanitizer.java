package com.payment.stripeintegration.security.xss;
...
public class XSSSanitizer extends JsonDeserializer<String> implements ContextualDeserializer {
    ...
    public static final PolicyFactory POLICY_FACTORY = new HtmlPolicyBuilder().allowCommonInlineFormattingElements().toFactory();
